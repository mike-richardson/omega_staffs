...
<body class="<?php print $body_classes; ?> <?php print themer_body_class(); ?>">
  ...
  <div id="header">
	   		<div class="wrapper">
				<a href="http://demo.supportforme.info" title="<?php print t('Home'); ?>"> <img src="http://demo.supportforme.info/sites/all/themes/supportforme/images/logo.png" alt="<?php print t('Home'); ?>" class="logo-fix" /></a>
